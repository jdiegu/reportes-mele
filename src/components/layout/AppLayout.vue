            ...
            <div class="max-w-md mx-auto">
              ...
              <div class="flex flex-col items-center gap-2.5">
                <div class="flex items-center gap-2">
                  <img src="/icon.png" alt="Ventas Luna Rosa" class="w-6 h-6 rounded-md object-cover" style="border-radius: 0.375rem" />
                  <span class="font-bold text-[13px] tracking-tight" style="color: var(--text-primary)">Ventas Luna Rosa</span>
                </div>
                <a :href="whatsappGroupLink" target="_blank" rel="noopener" class="group flex items-center gap-1.5 text-[11px] font-semibold px-3 py-1.5 rounded-lg no-underline transition-all hover:scale-105 active:scale-95"
                   :style="{ background: 'var(--rose-gradient)', color: 'white', boxShadow: '0 3px 10px rgba(224,36,121,0.45)' }">
...
const roleLabel = computed(() => {
  ...
  return map[route.name] || "Ventas Luna Rosa";
});
